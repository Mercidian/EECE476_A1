...
static counter_t g_total_fcomp_instr;
static counter_t g_total_store_instr;
static counter_t g_total_load_instr;
static counter_t g_total_imm_instr;
/* A1_ */
/* _A1-3.2 */
static int cond_branch_offset;
/* A1_ */
...
stat_reg_counter(sdb, "sim_num_fcomp_instr" /* label for printing */, 
                 "total floating-point instruction executed" /* description */, 
                 &g_total_fcomp_instr /* pointer to the counter */,  
    0 /* initial value for the counter */, NULL); 
stat_reg_formula(sdb, "sim_fcomp_instr_freq", 
                 "relative frequency of floating-point instructions", 
                 "sim_num_fcomp_instr / sim_num_insn", NULL); 

stat_reg_counter(sdb, "sim_num_store_instr" /* label for printing */, 
                 "total store instruction executed" /* description */, 
                 &g_total_store_instr /* pointer to the counter */,  
    0 /* initial value for the counter */, NULL); 
stat_reg_formula(sdb, "sim_store_instr_freq", 
                 "relative frequency of store instructions", 
                 "sim_num_store_instr / sim_num_insn", NULL); 

stat_reg_counter(sdb, "sim_num_load_instr" /* label for printing */, 
                 "total load instruction executed" /* description */, 
                 &g_total_load_instr /* pointer to the counter */,  
    0 /* initial value for the counter */, NULL); 
stat_reg_formula(sdb, "sim_load_instr_freq", 
                 "relative frequency of load instructions", 
                 "sim_num_load_instr / sim_num_insn", NULL); 

stat_reg_counter(sdb, "sim_num_imm_instr" /* label for printing */, 
                 "total immediate instruction executed" /* description */, 
                 &g_total_imm_instr /* pointer to the counter */,  
    0 /* initial value for the counter */, NULL); 
stat_reg_formula(sdb, "sim_imm_instr_freq", 
                 "relative frequency of immediate instructions", 
                 "sim_num_imm_instr / sim_num_insn", NULL); 
/* A1_ */
...
#define DEFINST(OP,MSK,NAME,OPFORM,RES,FLAGS,O1,O2,I1,I2,I3)		\
	case OP:							\
          /* _A1-3.3 */
          dst_reg = O1;                                                 \
          if(dst_reg <= 31 && dst_reg > 0){                             \
		regOld[dst_reg] = regs.regs_R[dst_reg];                 \
          }                                                             \
          /* A1_ */
          SYMCAT(OP,_IMPL);						\
          break;
